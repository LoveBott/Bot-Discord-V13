...
module.exports = {
    ...
    run: async(client) => {
        ...
        .setDescription(`**El Client \`${client.user.tag}\` ||${client.user.id}|| Esta Listo!\nPing: ${client.ws.ping}MS\nUptime: <t:${parseInt(client.readyTimestamp / 1000)}:R>**`)
        .setColor('RANDOM').setTimestamp().setFooter(`Estoy En ${client.channels.cache.size} Channels | ${client.guilds.cache.size} Servers | Owner: ${ownerTag}`)
